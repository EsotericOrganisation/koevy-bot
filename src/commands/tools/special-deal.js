...
module.exports = {
	...
	async execute(interaction, client) {
		const embed = new EmbedBuilder()
			...
			.setColor(0x6410a2)
			.setThumbnail(
				`https://cdn.discordapp.com/attachments/1068500856179273818/1072634980708143124/fire512-512.png`
			)
			.setImage(
				"https://media.discordapp.net/attachments/1044272149453619210/1073940524442075196/Sepcial-Deal.png"
			)
			.setAuthor({
