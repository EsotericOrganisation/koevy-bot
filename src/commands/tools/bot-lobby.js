...
module.exports = {
	...
	async execute(interaction, client) {
		...
		const embed = new EmbedBuilder()
			...
			.setThumbnail(
				`https://media.discordapp.net/attachments/1044272149453619210/1073905332679606286/LevelUP.png`
			)
			...
			.setImage(
				`https://media.discordapp.net/attachments/1044272149453619210/1074286529167491112/Bot-Lobbies.png?width=1246&height=701`
			)
