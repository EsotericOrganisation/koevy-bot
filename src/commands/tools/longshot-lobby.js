...
module.exports = {
	...
	async execute(interaction, client) {
		...
		const embed = new EmbedBuilder()
			...
			.setThumbnail(
				`https://cdn.discordapp.com/attachments/1044272149453619210/1073905332272771092/Longshot.png`
			)
			...
			.setImage(
				`https://media.discordapp.net/attachments/1044272149453619210/1074286530744569937/Longshot-Lobbies.png?width=1246&height=701`
			)
