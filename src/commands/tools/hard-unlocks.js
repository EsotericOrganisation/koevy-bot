...
module.exports = {
	...
	async execute(interaction, client) {
		...
		const embed = new EmbedBuilder()
			...
			.setThumbnail(
				`https://media.discordapp.net/attachments/1044272149453619210/1073901510313914468/Unlock.png`
			)
			...
			.setImage(
				`https://media.discordapp.net/attachments/1044272149453619210/1074286530169933935/Hard-Unlocks.png?width=1246&height=701`
			)
