...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (!interaction.member.roles.cache.has(supportRoleId)) return await interaction.reply({
    ...
    const embed = new EmbedBuilder()
      ...
      .setColor(0x6410a2)
      .setDescription("Open a Ticket below by Selecting the Product you want Information on!")
      .setThumbnail("https://cdn.discordapp.com/attachments/1044272149453619210/1073901510922084352/Ticket.png")
      // .setFields()
      .setImage("https://media.discordapp.net/attachments/1044272149453619210/1073940537498947584/Ticket.png")
      .setFooter({ text: "Stop Grinding now, and take the Easy way", iconURL: "https://cdn.discordapp.com/attachments/1052647799751188510/1073694365647634463/NEW_PFP_img.png" });
