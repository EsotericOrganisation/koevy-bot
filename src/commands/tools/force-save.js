...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    .setThumbnail(`https://media.discordapp.net/attachments/1044272149453619210/1073907470503792740/Force-Save.png`)
    ...
    .setImage(`https://media.discordapp.net/attachments/1044272149453619210/1074286529670828073/Force-Save.png?width=1246&height=701`)
