...
module.exports = {
	...
	async execute(interaction, client) {
		...
		const ticketData = {
			"bot-lobby": {
				category: "1068595279684702238",
				overflow: "",
				name: "Bot Lobbies",
			},
			"longshot-lobby": {
				category: "1068614944288931971",
				overflow: "",
				name: "Longshot Lobbies",
			},
			"force-save": {
				category: "1068614500883890176",
				overflow: "",
				name: "Force Save",
			},
			"hard-unlocks": {
				category: "1068614620664844318",
				overflow: "",
				name: "Hard Unlocks",
			},
			"nuke": {
				category: "1073676664900423740",
				overflow: "",
				name: "Nuke Service",
			},
		};
					...
					await c.send({
						...
						embeds: [
							new EmbedBuilder()
								...
								.setDescription(
									`> You have opened a ticket for ${bold(
										name
		...
		return ticketChannel
			? await interaction.followUp({
					content: `Your ticket has been created in ${channelMention(
						ticketChannel
					)}!`,
					ephemeral: true,
			  })
